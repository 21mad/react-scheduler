...
export const headerYearHeight = 40;
export const headerMonthHeightYearView = 40;
export const headerHeightYearView = headerYearHeight + headerMonthHeightYearView;
export const weekWidth = 84;
export const monthWidth = 122;
export const boxHeight = 56;
export const leftColumnWidth = 196;
export const singleDayWidth = 12;
export const singleDayWidthInYear = 4;
...
// export const zoomFullYearlyHeaderHeight = zoom2HeaderTopRowHeight + zoom2HeaderMiddleRowHeight;
...
export const topRowTextYPosYearView = headerMonthHeightYearView / 2 + 2;
export const middleRowTextYPos = headerWeekHeight / 2 + headerMonthHeight + 1;
export const middleRowTextYPosYearView = headerMonthHeightYearView / 2 + headerYearHeight + 1;
export const buttonWeeksJump = 2;
export const buttonMonthsJump = 6;
